...
<p align="center">
  <sub><strong>All-time range at a glance.</strong> See where today's price sits between ATL and ATH, based on Pricempire price data since tracking began for the item.</sub>
</p>
